...
import { Shield, Calendar, Users, Trophy, Package, Award, Sparkles, ShoppingBag, Zap, Gamepad2, UserPlus, Crown, Settings, Activity, ScanLine, Megaphone, Vote } from 'lucide-react';
...
const SECTIONS = [
  ...
  { to: '/admin/polls', icon: Vote, label: 'Encuestas' },
